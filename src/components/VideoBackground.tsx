  ...
  return (
    <div className="relative w-full h-screen overflow-hidden">
      ...
      <div className="relative z-10 h-full flex flex-col items-center justify-center text-white px-4 text-center">
        ...
        >
          <span className="text-pizza-gold">Il Capriccio</span>
          <br />
          <span className="italic">Pizzeria</span>
          <br />
          <span className="text-2xl md:text-3xl lg:text-4xl font-light">di Paolo di Pietro</span>
        </motion.h1>

        <motion.div 
          className="h-1 bg-pizza-gold mx-auto mb-8"
